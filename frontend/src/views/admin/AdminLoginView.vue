<!--
  ...
  Credentials are verified by the backend. Default creds are set in
  application.properties — change before going to production.
-->
<template>
...
async function login() {
  ...
  try {
    ...
    // Store token returned by the backend
